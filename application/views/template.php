...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/images/profil1.jpg" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Maulana Pranasutra Cahyoaji</div>
                    <div class="email">maulana_pranasutra_26rpl@student.smktelkom-mlg.sch.id</div>
